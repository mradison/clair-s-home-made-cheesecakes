    ...
    <main className="main">
      ...
      <section className="ourServices">
        ...
        <ul>
          ...
          <p>Mini Cheesecake Cupcakes – 24 cupcakes for $20, or 48 cupcakes for $35</p>
          <div className="imageItem">
            <img className="frontPics" src={Caramelapplecupcakes} alt="Before Picture" />
          </div>
          <div className="title">"Caramel Apple Cupcakes"</div>
          <p>Cheesecake Bars 2x2 – 16 for $30, 24 bars for $35, or 48 bars for $60</p>
          <div className="imageItem">
            <img className="frontPics" src={Mixedberrybars} alt="Before Picture" />
          </div>
          <div className="title">"Mixed Berry Bars"</div>
          <p>Cheesecake Bites 1x1 – 64 for $30, or 96 bars for $40</p>
          <div className="imageItem">
            <img className="frontPics" src={Cheescakebites2} alt="Before Picture" />
          </div>
          <div className="title">"Cheesecake Bites"</div>
          <p>“All about the Crust” – This is cheesecake encased in graham cracker crust! - 8 inch $35 or 9 $40, or 10 inch $45 - add $5 dollars and I will add in the flavor or topping of your choice</p>
          <p>Seasonal Favorites or anytime you like - 8 inch $30, 9 inch $35, or 10 inch $40</p>
          <div className="imageItem">
